package com.popa.microservices.composite.product.integrationlayer;
...
public class ProductCompositeIntegration implements ProductServiceAPI, RecommendationServiceAPI, ReviewServiceAPI {
    ...
    @Override
    public void deleteRecommendations(int productId) { // sed a DELETE by productId tp recommendation service
